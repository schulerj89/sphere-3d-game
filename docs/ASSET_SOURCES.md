...
This repository uses only assets whose source page and license were checked on 2026-07-12. Bundled third-party 3D, fallback music, and SFX assets are under [CC0 1.0 Universal](https://creativecommons.org/publicdomain/zero/1.0/); the remote display fonts are under the SIL Open Font License 1.1. The bespoke Eleven Music track is governed by [ElevenLabs Music Terms](https://elevenlabs.io/music-terms), not CC0, and is included solely as the game's embedded soundtrack. Credit is not legally required for the CC0 media, but the project keeps voluntary credits in `ATTRIBUTIONS.md`.
...
| `Bungee` and `Oxanium` | [Google Fonts](https://fonts.google.com/), [SIL Open Font License 1.1](https://openfontlicense.org/) | Display/UI typography | Remote CSS only | `src/styles.css` | Bungee gives the title its arcade silhouette; Oxanium keeps HUD text compact and readable. Browser fallbacks remain available if Google Fonts is unreachable. |
...
- `https://static.poly.pizza/484450a4-b76c-4e76-95d2-352337bb41e8.glb`
- `https://static.poly.pizza/1381b02a-8310-437b-a2a7-82cab0a94a4c.glb`
