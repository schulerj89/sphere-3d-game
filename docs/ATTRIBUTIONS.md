...
The demo's third-party media is CC0 1.0 Universal (public-domain dedication), except for the embedded Eleven Music soundtrack and OFL display fonts. Attribution is not required for the CC0 assets, but the project voluntarily preserves the following source credits.
...
| 8-bit Platformer SFX | MoxieCat | https://opengameart.org/content/8-bit-platformer-sfx-0 | CC0 1.0 Universal | UI, jump, dash, damage, and enemy-defeat sounds |
| Coin sound effect - Harmonica | Chadderbox | https://opengameart.org/content/coin-sound-effect-harmonica | CC0 1.0 Universal | Coin collection sound |
| Bungee and Oxanium | Font creators via Google Fonts | https://fonts.google.com/ | SIL Open Font License 1.1 | Title and HUD typography |

License text: https://creativecommons.org/publicdomain/zero/1.0/

If an asset is removed from the repository, remove its corresponding row here and from `docs/ASSET_SOURCES.md` in the same change.
